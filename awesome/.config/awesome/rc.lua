...
local taglist_buttons = gears.table.join(
                    awful.button({ }, 1, function(t)
                        local num = tonumber(t.name:sub(1,1));
                        tagmgr.determine(num, t.screen):view_only()
                    end),
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist = awful.widget.taglist(s, tagmgr.taglist_filter, taglist_buttons)
...
root.buttons(gears.table.join(
    awful.button({ }, 3, function () mymainmenu:toggle() end),
    awful.button({ }, 4, function() tagmgr.move_by( 1) end),
    awful.button({ }, 5, function() tagmgr.move_by(-1) end)
))
-- }}}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "z", function () awful.spawn("thunar") end,
        {description = "open thunar", group = "awesome"}),
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn("firefox-developer-edition") end,
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Shift" }, "#" .. i + 9,
                  function ()
                      if client.focus then
                          client.focus:move_to_tag(tagmgr.determine(i))
                     end
                  end,
